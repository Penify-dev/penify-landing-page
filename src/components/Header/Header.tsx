...
/**
 * Represents the main navigation header component of the application.
 * It includes elements such as a logo, currency dropdown, dashboard link, and a mobile menu button.
 *
